...
\begin{figure}[p]
	...
	\caption{Some competition diagrams of robot $r0$ in one run of experiment P.1. Figures (a) and (b) show referent-form competitions for \textsc{L}\oldstylenums{1}, (a) show its use and (b) shows the successful use. Figure (c) shows the referent-meaning competition for \textsc{L}\oldstylenums{1} and (d) shows the form-meaning competition for {\it tyfo}. Both Figure (c) and (d) show the use. Figures (e) and (f) show the form-referent diagrams for {\it tyfo}, where (e) shows its use, and (f) its effective use.\index{competition diagram}}
	\label{f:opt:ggcomp1}
\end{figure}
