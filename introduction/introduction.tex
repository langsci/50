...
\begin{table}[t]
\begin{tabular}{p{3.5cm}cccccccc}
\lsptoprule
Aspect & B & C & D & O & R & S & V & Y\\\midrule
Grounded in real world & + & - & - & - & + & + & + & +\\
Language pre-defined & + & + & - & - & $\cdot$ & - & - & +\\
Meaning pre-defined & +/- & - & - & + & - & - & - & +\\
Prototypical categories & - & - & - & $\cdot$ & + & - & + & -\\
Hierarchical layering of categories & - & - & + & $\cdot$ & - & + & + & -\\
Nr. of meanings given & +/- & - & - & + & - & - & - & +\\
Nr. of forms given & + & + & - & + & $\cdot$ & - & - & +\\
Nr. of agents & 2 & $\geq 2$ & $\geq 2$ & $\geq 2$ & 1 & $\geq 2$ & 2 & $\geq 2$\\
Calibrated world & - & - & - & $\cdot$ & - & + & - & -\\
Mobile agents & + & + & + & $\cdot$ & + & - & + & +\\
Camera vision & - & $\cdot$ & $\cdot$ & $\cdot$ & - & + & - & -\\
Autonomous & + & + & + & + & + & + & + & -\\
Task oriented & + & + & + & - & - & - & - & +\\
