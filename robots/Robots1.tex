...
The Vesta board (see \figref{f:vesta}) contains a Motorola MC68332 microcontroller, 128 kB ROM and 1 MB RAM.\footnote{In the original version of the {\sc smbii} there were only 256 kB RAM \citep{vereertbrugghen:1996}.} The board's micro-controller runs at 16.78 MHz at 5 Volt and everything is powered by a pack of rechargeable Nickel-Cadmium batteries.
